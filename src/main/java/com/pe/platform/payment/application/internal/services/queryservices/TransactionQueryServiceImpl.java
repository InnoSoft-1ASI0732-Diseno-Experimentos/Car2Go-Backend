...
/**
 * The type Transaction query service.
 */
@Service
public class TransactionQueryServiceImpl implements TransactionQueryService {
  ...
  /**
   * Instantiates a new Transaction query service.
   *
  ...
  public List<Transaction> handle(GetAllTransactionsQuery query) {
    ...
    if (hasBuyerRole) {
      List<Transaction> buyerTransactions =
          transactionRepository.findAllByBuyerId(userDetails.getId());
      return buyerTransactions.isEmpty() ? List.of() : buyerTransactions;
    } else if (hasSellerRole) {
      List<Transaction> sellerTransactions =
          transactionRepository.findAllBySellerId(userDetails.getId());
