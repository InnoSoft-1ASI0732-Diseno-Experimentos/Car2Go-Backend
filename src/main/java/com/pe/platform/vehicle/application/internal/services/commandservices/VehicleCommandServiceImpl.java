...
/**
 * The type Vehicle command service.
 */
@Service
public class VehicleCommandServiceImpl implements VehicleCommandService {
  ...
  /**
   * Instantiates a new Vehicle command service.
   *
  ...
  public Optional<Vehicle> handle(UpdateVehicleCommand command, int vehicleId) {
    ...
    if (vehicleOptional.isEmpty() || vehicleOptional.get().getProfileId() != userId) {
      throw new IllegalStateException(
          "The vehicle does not exist or you do not have permission to update it.");
    }
  ...
  public void deleteVehicle(int vehicleId, long userId) {
    ...
    if (vehicleOptional.isEmpty() || vehicleOptional.get().getProfileId() != userId) {
      throw new IllegalStateException(
          "The vehicle does not exist or you do not have permission to delete it.");
    }
