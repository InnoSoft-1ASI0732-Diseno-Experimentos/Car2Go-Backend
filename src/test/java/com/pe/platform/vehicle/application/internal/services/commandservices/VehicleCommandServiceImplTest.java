...
class VehicleCommandServiceImplTest {
    ...
    void testHandleCreateVehicleCommandNonSellerUser() {
        ...
        try (MockedStatic<SecurityContextHolder> securityContextHolder = Mockito.mockStatic(SecurityContextHolder.class)) {
            ...
            UserDetailsImpl nonSellerUser = new UserDetailsImpl(USER_ID, "testuser", "test@example.com", authorities);
    ...
    void testHandleUpdateVehicleCommandNonExistentVehicle() {
        ...
        try (MockedStatic<SecurityContextHolder> securityContextHolder = Mockito.mockStatic(SecurityContextHolder.class)) {
            ...
            // Act & Assert
            assertThrows(IllegalStateException.class, () -> vehicleCommandService.handle(updateCommand, vehicleId));
    ...
    void testDeleteVehicleNonExistent() {
        ...
        // Act & Assert
        assertThrows(IllegalStateException.class, () -> vehicleCommandService.deleteVehicle(vehicleId, USER_ID));
