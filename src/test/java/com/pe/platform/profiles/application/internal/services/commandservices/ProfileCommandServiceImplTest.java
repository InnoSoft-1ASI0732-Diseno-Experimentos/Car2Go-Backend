...
class ProfileCommandServiceImplTest {
    ...
    void testAddPaymentMethodToNonExistentProfile() {
        ...
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> profileCommandService.addPaymentMethod(USER_ID, paymentMethod));
    ...
    void testAddPaymentMethodExceedingLimit() {
        ...
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> profileCommandService.addPaymentMethod(USER_ID, extraPaymentMethod));
