...
/**
 * The type Profiles controller test.
 */
class ProfilesControllerTest {
  ...
  void testCreateProfile() throws Exception {
    ...
    when(profileCommandService.handle(any(CreateProfileCommand.class))).thenReturn(
        Optional.of(profile));
  ...
  void testGetMyProfile() throws Exception {
    ...
    when(profileQueryService.handle(any(GetProfileByIdQuery.class))).thenReturn(
        Optional.of(profile));
  ...
  void testUpdateProfile() throws Exception {
    ...
    when(profileCommandService.handle(any(UpdateProfileCommand.class))).thenReturn(
        Optional.of(updatedProfile));
  ...
  /**
   * Test add payment method profile not found.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  /**
   * Test add payment method exceeds limit.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  /**
   * Test get profile by id not found.
   *
   * @throws Exception the exception
   */
  @Test
